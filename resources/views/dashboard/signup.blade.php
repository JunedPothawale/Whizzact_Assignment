                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-4">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                @endisset
                                <form method="POST" action="{{ route('updatePost',$userdata->id) }}">
                                    @csrf
                                    {{-- <input type="hidden" name="id" value="{{  }}"> --}}
                                    <div class="mb-3">
                                        <label for="FullName" class="form-label">Full Name</label>
                                        <input type="text" name="fname" class="form-control" id="FullName"
                                            aria-describedby="textHelp" value="{{ $userdata->name }}" required>
                                        @error('fname')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" id="Email"
                                            aria-describedby="emailHelp" value="{{ $userdata->email }}" required>
                                        @error('email')
                                            <p class="text-danger fw-semibold ms-2 mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="password" name="password_confirmation" class="form-control"
                                            id="ConfirmPassword" required value="{{ $userdata->password }}">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="mobile" pattern="^[6-9]\d{9}$" class="form-control"
                                    ...
                                    <div class="mb-4 d-flex justify-content-evenly">
                                        <div>
                                            ...
                                            <input type="radio" name="gender" value="0" class="form-radio-input"
                                                id="Male" required {{ $userdata->gender == 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="pincode" id="pincode" class="form-control"
                                            value="{{ $userdata->pincode }}" pattern="^[1-9][0-9]{5}$" id="pincode">
                                        @error('pincode')
                                            <p class="text-danger fw-semibold ms-2 mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
